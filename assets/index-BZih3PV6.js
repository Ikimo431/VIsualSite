...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Jm=(e,t)=>new ac(e,t)}),oc,fa,uc,lc,dc,cc,vt,eg,tg,Mr=j(()=>{fe(),ge(),Ke(),_e(),oc=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},fa=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),uc=(e,t)=>B.sortBasedOnPerm(e,fa(e.length,t)),lc=(e,t,r,i)=>{let n=`fn perm(i: ${i.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`;for(let s=0;s<t;++s)n+=`a[${e[s]}]=i[${s}];`;return n+="return a;}"},dc=(e,t)=>{let r=[],i=[];for(let n=0;n<e.length;++n)e[n]!==1&&r.push(e[n]),e[t[n]]!==1&&i.push(t[n]);return{newShape:r,newPerm:i}},cc=(e,t)=>{let r=0;for(let i=0;i<e.length;++i)if(t[e[i]]!==1){if(e[i]<r)return!1;r=e[i]}return!0},vt=(e,t)=>{let r=e.dataType,i=e.dims.length,n=fa(i,t),s=uc(e.dims,n),a=e.dims,o=s,u=i<2||cc(n,e.dims),d;if(u)return d=_=>{let w=P("input",r,a,4),T=se("output",r,o,4);return`
  ${_.registerUniform("output_size","u32").declareVariables(w,T)}
  ${_.mainStart()}
    ${_.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let _=B.size(s);return{outputs:[{dims:s,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(_/64/4)},programUniforms:[{type:12,data:Math.ceil(_/4)}]}},getShaderSource:d};let{newShape:c,newPerm:f}=dc(e.dims,n),m=B.areEqual(f,[2,3,1]),y=B.areEqual(f,[3,1,2]);if(c.length===2||m||y){a=m?[c[0],c[1]*c[2]]:y?[c[0]*c[1],c[2]]:c,o=[a[1],a[0]];let _=16;return d=w=>{let T=P("a",r,a.length),$=se("output",r,o.length);return`
  ...
  ${_.mainStart()}
    ...
    ${T.setByOffset("global_idx",w.getByIndices("aIndices"))}
       ...
       `,_=w=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${m}`,inputDependencies:["type"]},getShaderSource:_,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:u},programUniforms:[{type:12,data:d}]})}},Ot=(e,t,r,i)=>{let n=e.inputs.length===1?r:ao(e.inputs,r),s=n.axes;s.length===0&&!n.noopWithEmptyAxes&&(s=e.inputs[0].dims.map((y,_)=>_));let a=B.normalizeAxes(s,e.inputs[0].dims.length),o=a,u=e.inputs[0],d=bc(o,e.inputs[0].dims.length);d.length>0&&(u=e.compute(vt(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],o=gc(o.length,u.dims.length));let[c,f]=yc(u.dims,o),m=c;n.keepDims&&(m=_c(c,a)),e.compute($c(t,n.cacheKey,[u],i,e.inputs[0].dataType,m,f),{inputs:[u]})},rg=(e,t)=>{Ot(e,"ReduceMeanShared",t,"mean")},ig=(e,t)=>{Ot(e,"ReduceL1Shared",t,"l1")},ng=(e,t)=>{Ot(e,"ReduceL2Shared",t,"l2")},sg=(e,t)=>{Ot(e,"ReduceLogSumExpShared",t,"logSumExp")},ag=(e,t)=>{Ot(e,"ReduceMaxShared",t,"max")},og=(e,t)=>{Ot(e,"ReduceMinShared",t,"min")},ug=(e,t)=>{Ot(e,"ReduceProdShared",t,"prod")},lg=(e,t)=>{Ot(e,"ReduceSumShared",t,"sum")},dg=(e,t)=>{Ot(e,"ReduceSumSquareShared",t,"sumSquare")},cg=(e,t)=>{Ot(e,"ReduceLogSumShared",t,"logSum")}}),Rt,vc,rs,ao,Mt,xc,Sc,Tc,Ic,Ec,kc,Cc,zc,Ac,Oc,Bt,pg,fg,hg,mg,gg,yg,_g,wg,bg,$g,Xo=j(()=>{fe(),ge(),Ke(),_e(),t1(),Rt=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},vc=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],rs=(e,t,r,i,n,s,a=!1,o=!1)=>{let u=[],d=r[0].dims,c=d.length,f=B.normalizeAxes(n,c),m=!o&&f.length===0;d.forEach((w,T)=>{m||f.indexOf(T)>=0?a&&u.push(1):u.push(w)});let y=u.length,_=B.size(u);return{name:e,shaderCache:t,getShaderSource:w=>{let T=[],$=P("_A",r[0].dataType,c),b=se("output",s,y),E=i($,b,f),x=E[2];for(let I=0,A=0;I<c;I++)m||f.indexOf(I)>=0?(a&&A++,x=`for(var j${I}: u32 = 0; j${I} < ${d[I]}; j${I}++) {
...
`)}
        }`},getRunData:()=>({outputs:[{dims:u,dataType:s}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:[{type:12,data:_},...de(d,u)]})}},ao=(e,t)=>{let r=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(i=>r.push(Number(i))),Oe({axes:r,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},Mt=(e,t,r,i)=>{let n=e.inputs,s=n.length===1?r:ao(n,r);e.compute(rs(t,{hint:s.cacheKey,inputDependencies:["rank"]},[n[0]],s.noopWithEmptyAxes&&s.axes.length===0?vc:i,s.axes,n[0].dataType,s.keepDims,s.noopWithEmptyAxes),{inputs:[0]})},xc=(e,t)=>{Rt(e.inputs),Mt(e,"ReduceLogSum",t,(r,i)=>[`var value = ${i.type.storage}(0);`,"",`value += ${r.getByIndices("input_indices")};`,"value = log(value);"])},Sc=(e,t)=>{Rt(e.inputs),Mt(e,"ReduceL1",t,(r,i)=>[`var value = ${i.type.storage}(0);`,"",`value += abs(${r.getByIndices("input_indices")});`,""])},Tc=(e,t)=>{Rt(e.inputs),Mt(e,"ReduceL2",t,(r,i)=>[`var t = ${i.type.value}(0); var value = ${i.type.value}(0);`,"",`t = ${r.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])},Ic=(e,t)=>{Rt(e.inputs),Mt(e,"ReduceLogSumExp",t,(r,i)=>[`var value = ${i.type.storage}(0);`,"",`value += exp(${r.getByIndices("input_indices")});`,"value = log(value);"])},Ec=(e,t)=>{Rt(e.inputs),Mt(e,"ReduceMax",t,(r,i,n)=>{let s=[];for(let a=0;a<r.rank;a++)(n.indexOf(a)>=0||n.length===0)&&s.push(r.indicesSet("input_indices",a,0));return[`${s.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};`,`value = max(value, ${r.getByIndices("input_indices")});`,""]})},kc=(e,t)=>{Rt(e.inputs),Mt(e,"ReduceMean",t,(r,i,n)=>{let s=1;for(let a=0;a<r.rank;a++)(n.indexOf(a)>=0||n.length===0)&&(s*=e.inputs[0].dims[a]);return["var sum = f32(0);","",`sum += f32(${r.getByIndices("input_indices")});`,`let value = ${i.type.value}(sum / ${s});`]})},Cc=(e,t)=>{Rt(e.inputs),Mt(e,"ReduceMin",t,(r,i,n)=>{let s=[];for(let a=0;a<r.rank;a++)(n.indexOf(a)>=0||n.length===0)&&s.push(`input_indices[${a}] = 0;`);return[`${s.join(`
`)}`,`var value = ${r.getByIndices("input_indices")};`,`value = min(value, ${r.getByIndices("input_indices")});`,""]})},zc=(e,t)=>{Rt(e.inputs),Mt(e,"ReduceProd",t,(r,i)=>[`var value = ${i.type.storage}(1);`,"",`value *= ${r.getByIndices("input_indices")};`,""])},Ac=(e,t)=>{Rt(e.inputs),Mt(e,"ReduceSum",t,(r,i)=>[`var value = ${i.type.storage}(0);`,"",`value += ${r.getByIndices("input_indices")};`,""])},Oc=(e,t)=>{Rt(e.inputs),Mt(e,"ReduceSumSquare",t,(r,i)=>[`var t = ${i.type.value}(0); var value = ${i.type.value}(0);`,"",`t = ${r.getByIndices("input_indices")}; value += t * t;`,""])},Bt=(e,t,r)=>{if(t.length===0)return r;let i=1,n=1;for(let s=0;s<t.length;s++)t.indexOf(s)===-1?i*=e[s]:n*=e[s];return n<32&&i>1024},pg=(e,t)=>{Bt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?kc(e,t):rg(e,t)},fg=(e,t)=>{Bt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Sc(e,t):ig(e,t)},hg=(e,t)=>{Bt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Tc(e,t):ng(e,t)},mg=(e,t)=>{Bt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Ic(e,t):sg(e,t)},gg=(e,t)=>{Bt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Ec(e,t):ag(e,t)},yg=(e,t)=>{Bt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Cc(e,t):og(e,t)},_g=(e,t)=>{Bt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?zc(e,t):ug(e,t)},wg=(e,t)=>{Bt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Ac(e,t):lg(e,t)},bg=(e,t)=>{Bt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Oc(e,t):dg(e,t)},$g=(e,t)=>{Bt(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?xc(e,t):cg(e,t)}}),ha,vg,xg,oo,r1=j(()=>{fe(),Ke(),Xo(),ha=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},vg=(e,t)=>{ha(e.inputs);let r=(i,n,s)=>{let a=[];for(let o=0;o<i.rank;o++)(s.indexOf(o)>=0||s.length===0)&&a.push(`input_indices[${o}] = 0;`);return[`${a.join(`
...
`,Fc=e=>`quick_gelu_impl(${e})`,oy=(e,t)=>{let r=lt(e.inputs[0].dataType);e.compute(Ae(e.inputs[0],"QuickGelu",Fc,Gc(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),jc,Kc,uy,s1=j(()=>{ge(),_e(),eu(),jc=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Kc=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=P("input",e[0].dataType,e[0].dims,4),i=P("bias",e[0].dataType,[e[0].dims[2]],4),n=se("output",e[0].dataType,t,4),s=B.size(t)/4,a=Je(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:o=>`
  ...
  }`}},uy=e=>{jc(e.inputs),e.compute(Kc(e.inputs))}}),Qc,Zc,Nt,ly,dy,cy,py,fy,hy,my,gy,yy,_y,a1=j(()=>{fe(),ge(),_e(),Qc=(e,t,r,i,n,s,a,o,u,d,c,f)=>{let m,y;typeof o=="string"?m=y=(b,E)=>`${o}((${b}),(${E}))`:typeof o=="function"?m=y=o:(m=o.scalar,y=o.vector);let _=se("outputData",c,i.length,4),w=P("aData",u,t.length,4),T=P("bData",d,r.length,4),$;if(n)if(s){let b=B.size(t)===1,E=B.size(r)===1,x=t.length>0&&t[t.length-1]%4===0,I=r.length>0&&r[r.length-1]%4===0;b||E?$=_.setByOffset("global_idx",y(b?`${w.type.value}(${w.getByOffset("0")}.x)`:w.getByOffset("global_idx"),E?`${T.type.value}(${T.getByOffset("0")}.x)`:T.getByOffset("global_idx"))):$=`
...
`}return L};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${f};${m};${y};${n}`,inputDependencies:w?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:b}),getShaderSource:E}}}),tp,rp,co,ga,ip,po,np,is,su=j(()=>{fe(),ge(),_e(),ii(),nu(),ru(),tp=(e,t)=>e?`
...
`},np=(e,t,r,i,n=!1)=>{let[s,a,o,u]=i,d=Je(i[0].type.tensor);return`
  ...
  ${w?co(T,$,Q,L):po(T,$,Q,L)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${I}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${w?`vec4<${le}>`:le}) {
        ...
        ${w?co(E,b,le,void 0,!d,S):po(E,b,le,void 0,!d,S,!1,void 0,o)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${I};${w};${W};${G};${ue};${A};${R};${S}`,inputDependencies:N},getRunData:()=>({outputs:[{dims:u?u(r):r,dataType:e[0].dataType}],dispatchGroup:{x:x[0],y:x[1],z:x[2]},programUniforms:ae}),getShaderSource:L}}}),ap,ya,Oi,op,_a,up,Sy,Ty,d1=j(()=>{fe(),_r(),ge(),_e(),ii(),ru(),ap=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},ya=e=>typeof e=="number"?[e,e,e]:e,Oi=(e,t)=>t<=1?e:e+(e-1)*(t-1),op=(e,t,r,i=1)=>{let n=Oi(t,i);return Math.floor((e[0]*(r-1)-r+n)/2)},_a=(e,t,r,i,n)=>{n==null&&(n=op(e,t[0],i[0]));let s=[0,0,0,r];for(let a=0;a<3;a++)e[a]+2*n>=t[a]&&(s[a]=Math.trunc((e[a]-t[a]+2*n)/i[a]+1));return s},up=(e,t,r,i,n,s,a,o,u,d)=>{let c,f,m,y;if(e==="VALID"&&(e=0),typeof e=="number"){c={top:e,bottom:e,left:e,right:e,front:e,back:e};let _=_a([t,r,i,1],[o,u,d],1,[n,s,a],e);f=_[0],m=_[1],y=_[2]}else if(Array.isArray(e)){if(!e.every((w,T,$)=>w===$[0]))throw Error(`Unsupported padding parameter: ${e}`);c={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let _=_a([t,r,i,1],[o,u,d],1,[n,s,a],e[0]);f=_[0],m=_[1],y=_[2]}else if(e==="SAME_UPPER"){f=Math.ceil(t/n),m=Math.ceil(r/s),y=Math.ceil(i/a);let _=(f-1)*n+o-t,w=(m-1)*s+u-r,T=(y-1)*a+d-i,$=Math.floor(_/2),b=_-$,E=Math.floor(w/2),x=w-E,I=Math.floor(T/2),A=T-I;c={top:E,bottom:x,left:I,right:A,front:$,back:b}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:c,outDepth:f,outHeight:m,outWidth:y}},Sy=(e,t,r,i,n,s=!1,a="channelsLast")=>{let o,u,d,c,f;if(a==="channelsLast")[o,u,d,c,f]=e;else if(a==="channelsFirst")[o,f,u,d,c]=e;else throw new Error(`Unknown dataFormat ${a}`);let[m,,y,_,w]=t,[T,$,b]=ya(r),[E,x,I]=ya(i),A=Oi(y,E),R=Oi(_,x),S=Oi(w,I),{padInfo:W,outDepth:G,outHeight:ue,outWidth:re}=up(n,u,d,c,T,$,b,A,R,S),ae=s?m*f:m,N=[0,0,0,0,0];return a==="channelsFirst"?N=[o,ae,G,ue,re]:a==="channelsLast"&&(N=[o,G,ue,re,ae]),{batchSize:o,dataFormat:a,inDepth:u,inHeight:d,inWidth:c,inChannels:f,outDepth:G,outHeight:ue,outWidth:re,outChannels:ae,padInfo:W,strideDepth:T,strideHeight:$,strideWidth:b,filterDepth:y,filterHeight:_,filterWidth:w,effectiveFilterDepth:A,effectiveFilterHeight:R,effectiveFilterWidth:S,dilationDepth:E,dilationHeight:x,dilationWidth:I,inShape:e,outShape:N,filterShape:t}},Ty=(e,t,r,i,n,s)=>{let a=s==="channelsLast";a?e[0].dims[3]:e[0].dims[1];let o=[64,1,1],u={x:r.map((T,$)=>$)},d=[Math.ceil(ap(u.x.map(T=>r[T]))/o[0]),1,1];ke("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${d}`);let c=1,f=B.size(r),m=[{type:12,data:f},{type:12,data:i},{type:12,data:n},{type:12,data:t.strides},{type:12,data:t.dilations}];Jr(t,m),m.push(...de(e[0].dims,e[1].dims));let y=["rank","rank"],_=e.length===3;_&&(m.push(...de(e[2].dims)),y.push("rank")),m.push(...de(r));let w=T=>{let $=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:i.length},{name:"pads",type:"u32",length:n.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];ei(t,$);let b=1,E=Je(e[0].dataType),x=P("x",e[0].dataType,e[0].dims.length,c),I=P("W",e[1].dataType,e[1].dims.length,b),A=[x,I],R=se("result",e[0].dataType,r.length,b),S="";if(_){let ue=P("bias",e[2].dataType,e[2].dims.length,b);A.push(ue),S+=`
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${E} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${a};${c};${_}`,inputDependencies:y},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:d[0],y:d[1],z:d[2]},programUniforms:m}),getShaderSource:w}}}),Iy,Ey,c1=j(()=>{fe(),ge(),_e(),ii(),Iy=(e,t,r,i)=>{let n=e.length>2,s=n?"value += b[output_channel];":"",a=e[0].dims,o=e[1].dims,u=t.format==="NHWC",d=u?r[3]:r[1],c=d/t.group,f=u&&c>=4?je(d):1,m=B.size(r)/f,y=[{type:12,data:m},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:c}];Jr(t,y),y.push(...de(a,[o[0],o[1],o[2],o[3]/f]));let _=n?["rank","rank","rank"]:["rank","rank"];y.push(...de([r[0],r[1],r[2],r[3]/f]));let w=T=>{let $=se("output",e[0].dataType,r.length,f),b=Je($.type.tensor),E=Xr(t,$.type.value,b),x=P("x",e[0].dataType,a.length),I=P("w",e[1].dataType,o.length,f),A=[x,I];n&&A.push(P("b",e[2].dataType,e[2].dims,f));let R=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];ei(t,R);let S=u?`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${f}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:y}),getShaderSource:w}},Ey=(e,t,r,i)=>{let n=e.length>2,s=je(r[3]),a=je(r[2]),o=B.size(r)/s/a,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/s],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/s],c=[r[0],r[1],r[2],r[3]/s],f=[{type:12,data:o},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Jr(t,f),f.push(...de(u,d,c));let m=(a-1)*t.strides[1]+d[1],y=_=>{let w=se("output",e[0].dataType,c.length,s),T=Je(w.type.tensor),$=Xr(t,w.type.value,T),b=P("x",e[0].dataType,u.length,s),E=P("w",e[1].dataType,d.length,s),x=[b,E];n&&x.push(P("b",e[2].dataType,e[2].dims,s));let I=n?"value += b[output_channel];":"",A=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return ei(t,A),`
...
`)};
    ...
    ${_}`},c=[{type:12,data:u},...de(t,i)];return{name:"Expand",shaderCache:{hint:`${i.length};${a}${o}`,inputDependencies:["rank"]},getShaderSource:d,getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c})}},Dy=e=>{Ep(e.inputs),e.compute(Cp(e.inputs),{inputs:[0]})}}),zp,Py,w1=j(()=>{fe(),ge(),_e(),eu(),zp=e=>{let t=e[0].dataType,r=B.size(e[0].dims),i=B.size(e[1].dims),n=i%4===0,s=a=>{let o=P("x",t,[1],4),u=P("bias",t,[1],4),d=se("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],f=y=>`
...
`)}
  ...
  }`};e.compute({name:"InstanceNormalization",shaderCache:{hint:`${d}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:[{type:12,data:c},...de(m,y,m)]}),getShaderSource:w},{inputs:[t[0],f]})},af=(e,t,r)=>{let i=t[0].dims,n=i,s=i[0],a=i[i.length-1],o=B.sizeFromDimension(i,1)/a,u=je(a),d=B.size(n)/u,c=[{type:12,data:o},{type:12,data:Math.floor(a/u)}],f=["type","type"],m=!1,y=[0,i.length-1];for(let $=0;$<i.length-2;$++)m=m||i[$+1]!==1,y.push($+1);m=m&&i[i.length-1]!==1;let _=m?e.compute(vt(e.inputs[0],y),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:i.length},($,b)=>i[y[b]])),w=Ea(e,_,t[1],t[2],s,o,a,r.epsilon),T=$=>{let b=Je(t[0].dataType),E=u===1?"vec2f":`mat${u}x2f`,x=R=>{let S=R===0?"x":"y",W=u===1?"f32":`vec${u}f`;switch(u){case 1:return`${b}(${W}(scale.${S}))`;case 2:return`vec2<${b}>(${W}(scale[0].${S}, scale[1].${S}))`;case 4:return`vec4<${b}>(${W}(scale[0].${S}, scale[1].${S}, scale[2].${S}, scale[3].${S}))`;default:throw new Error(`Not supported compoents ${u}`)}},I=P("input",t[0].dataType,t[0].dims,u),A=se("output",t[0].dataType,n,u);return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:c}),getShaderSource:T},{inputs:[t[0],w]})},a0=(e,t)=>{t.format==="NHWC"?af(e,e.inputs,t):sf(e,e.inputs,t)}}),of,uf,o0,k1=j(()=>{fe(),ge(),_e(),of=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},uf=(e,t,r)=>{let i=t.simplified,n=e[0].dims,s=e[1],a=!i&&e[2],o=n,u=B.normalizeAxis(t.axis,n.length),d=B.sizeToDimension(n,u),c=B.sizeFromDimension(n,u),f=B.size(s.dims),m=a?B.size(a.dims):0;if(f!==c||a&&m!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
  ...
  ${I.mainStart()}
    ...
    ${b?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${f};${m};${T};${w}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:y,dataType:c}],dispatchGroup:{x},programUniforms:I}),getShaderSource:W}},l0=(e,t)=>{df(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(pf(e.inputs,t)):e.compute(cf(e.inputs,t))},d0=e=>Oe(e)}),ff,hf,mf,gf,yf,_f,wf,bf,c0,A1=j(()=>{fe(),ge(),_e(),ff=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},hf=(e,t,r)=>{let i="";for(let n=t-1;n>=0;--n)i+=`
    ...
    `,o="",u=P("x",t.dataType,t.dims.length),d=["rank"],[c,f,m,y,_]=Ca(s,n);return c.push(...de(t.dims,s)),{name:e,shaderCache:{hint:`${i.cacheKey};${m};${y};${_}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(B.size(s)/64)},programUniforms:c}),getShaderSource:w=>za(w,u,t.dims.length,s.length,n,a,o,t.dataType===10?-65504:-1e5,f,m,y,_)}},g0=(e,t)=>{Mi(e.inputs),e.compute(Ba("MaxPool",e.inputs[0],!1,t))},y0=e=>{let t=e.storage_order,r=e.dilations,i=Oa(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(i.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let n={storageOrder:t,dilations:r,...i,cacheKey:""};return{...n,cacheKey:vf(n)}},_0=e=>{let t=e.format;return{format:t,...Ma,cacheKey:t}},w0=(e,t)=>{Mi(e.inputs),e.compute(Ba("GlobalMaxPool",e.inputs[0],!0,t))}}),xf,Sf,b0,$0,R1=j(()=>{fe(),ge(),Ke(),_e(),xf=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((r,i)=>r&&i,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((n,s)=>s===t.axis||n===e[0].dims[s]).reduce((n,s)=>n&&s,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],i=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/i)||t.blockSize>Math.ceil(r/(i-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Sf=(e,t)=>{let r=B.normalizeAxis(t.axis,e[0].dims.length),i=e[0].dataType,n=i===3,s=e[0].dims,a=e[1].dataType,o=B.size(s),u=i===3||i===2,d=u?[Math.ceil(B.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,f=e.length>2?e[2]:void 0,m=f?u?[Math.ceil(B.size(f.dims)/4)]:f.dims:void 0,y=c.length===0||c.length===1&&c[0]===1,_=y===!1&&c.length===1,w=je(o),T=y&&(!u||w===4),$=T?w:1,b=T&&!u?w:1,E=P("input",u?12:i,d.length,b),x=P("scale",a,c.length),I=f?P("zero_point",u?12:i,m.length):void 0,A=se("output",a,s.length,$),R=[E,x];I&&R.push(I);let S=[d,c];f&&S.push(m);let W=[{type:12,data:o/$},{type:12,data:r},{type:12,data:t.blockSize},...de(...S,s)],G=ue=>{let re=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:I?["rank","rank","rank"]:["rank","rank"]},getShaderSource:G,getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:Math.ceil(o/$/64),y:1,z:1},programUniforms:W})}},b0=(e,t)=>{xf(e.inputs,t),e.compute(Sf(e.inputs,t))},$0=e=>Oe({axis:e.axis,blockSize:e.blockSize})}),Tf,If,v0,M1=j(()=>{zt(),fe(),_e(),Tf=(e,t,r)=>{let i=e===t,n=e<t&&r<0,s=e>t&&r>0;if(i||n||s)throw new Error("Range these inputs' contents are invalid.")},If=(e,t,r,i)=>{let n=Math.abs(Math.ceil((t-e)/r)),s=[n],a=n,o=[{type:12,data:a},{type:i,data:e},{type:i,data:r},...de(s)],u=d=>{let c=se("output",i,s.length),f=c.type.value,m=[{name:"outputSize",type:"u32"},{name:"start",type:f},{name:"delta",type:f}];return`
        ${d.registerUniforms(m).declareVariables(c)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${f}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${i}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:s,dataType:i}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:o})}},v0=e=>{let t=0,r=0,i=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],i=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],i=e.inputs[2].getFloat32Array()[0]),Ve.webgpu.validateInputContent&&Tf(t,r,i),e.compute(If(t,r,i,e.inputs[0].dataType),{inputs:[]})}}),Ef,kf,x0,S0,B1=j(()=>{fe(),ge(),Ke(),_e(),Ef=(e,t,r,i)=>{if(e!=="none"&&i!=="i32"&&i!=="u32"&&i!=="f32")throw new Error(`Input ${i} is not supported with reduction ${e}.`);let n=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,s=`;
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${Ef(t.reduction,"output[data_offset + i]","value",_.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:d}),getShaderSource:c}},x0=e=>Oe({reduction:e.reduction}),S0=(e,t)=>{e.compute(kf(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),Cf,zf,Af,Na,Of,Rf,Mf,Bf,Nf,Df,Pf,Uf,Da,Lf,Wf,qf,Vf,Hf,T0,I0,N1=j(()=>{fe(),ge(),Ke(),_e(),Cf=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`:"",Lf=(e,t,r,i,n)=>{let[s,a,o,u]=r.length===2?[-1,0,1,-1]:[0,2,3,1],d=e.type.value;return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${y} {
    ...
    }`},Vf=(e,t,r,i,n,s)=>{let a=e.dims,o=Mf(s,t.axes,a.length),u=Bf(a,i,n,t.axes),d=i.slice();i.length===0&&(d=a.map((b,E)=>b===0?1:u[E]/b),t.keepAspectRatioPolicy!=="stretch"&&(u=Nf(a,d,t)));let c=se("output",e.dataType,u.length),f=P("input",e.dataType,a.length),m=B.size(u),y=a.length===u.length&&a.every((b,E)=>b===u[E]),_=t.coordinateTransformMode==="tf_crop_and_resize",w=t.extrapolationValue,T=f.type.value,$=b=>`
      ${y?"":`
...
`}
      ...
      }`},x=[{dims:o,dataType:e[0].dataType}];return r>1&&x.push({dims:c,dataType:1}),r>2&&x.push({dims:c,dataType:1}),r>3&&x.push({dims:s,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${$};${y};${_};${w}`,inputDependencies:e.map((I,A)=>"type")},getShaderSource:E,getRunData:()=>({outputs:x,dispatchGroup:{x:Math.ceil(u/d)},programUniforms:b})}},E0=(e,t)=>{Gf(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(Ff(e.inputs,t,e.outputCount,!1),{outputs:r})}}),jf,Bi,Kf,Pa,Qf,Zf,k0,C0,P1=j(()=>{fe(),ge(),Ke(),_e(),jf=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,i)=>{if(e[i+1].dataType!==6&&e[i+1].dataType!==7)throw new Error(`Input ${i} must be an array of int32 or int64`)})},Bi=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(i=>r.push(Number(i)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(i=>r.push(Number(i)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Kf=(e,t)=>{if(e.length>1){let r=Bi(e,1),i=Bi(e,2),n=Bi(e,3);return n.length===0&&(n=[...Array(e[0].dims.length).keys()]),Oe({starts:r,ends:i,axes:n})}else return t},Pa=(e,t,r,i,n)=>{let s=e;return e<0&&(s+=r[i[t]]),n[t]<0?Math.max(0,Math.min(s,r[i[t]]-1)):Math.max(0,Math.min(s,r[i[t]]))},Qf=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
